    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          />
          <p className="text-center md:tracking-wider mb-4 md:text-lg text-sm lg:text-2xl">
            Hi, I&apos;m Shahzain, a web developer and I build websites that are fast, secure, and user-friendly.
          </p>
          <a href="/about">
          <MagicButton title="Show My Work!"/></a>
        </div>
      </div>
    </div>
  );
